...
0. Установить Git и создать репозиторий — это мы уже сделали

1. Клонировать его локально (`git clone https://github.com/..my_nick../..my_repo..`)
2. Добавить первую программу в репозиторий (`git add ....py`, затем `git commit -m "Welcome to the Future!"`)
3. Опубликовать программу (`git push origin master`)
4. Проверить изменения при помощи Web-интерфейса GitHub
5. Сообщить преподавателю, что задание сделано, чтобы преподаватель понял, чьи программы можно проверять
